...
export default function HomeScreen() {
  ...
  const renderHeader = () => (
    <>
      {/* Header */}        <View className="px-6 pb-6 bg-rose-50 rounded-b-3xl shadow-sm" style={{ paddingTop: Math.max(insets.top + 16, 40) }}>
      ...
      <View className="px-6 mt-6">
            <TouchableOpacity 
              className="bg-[#C1275A] rounded-3xl p-6 relative overflow-hidden shadow-sm border border-rose-600"
