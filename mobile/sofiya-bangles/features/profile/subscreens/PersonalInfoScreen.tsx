    ...
    <View className="flex-1 bg-[#FAFAFA]">
      ...
      >
        <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false}>
          ...
          <View className="bg-white flex-row items-center rounded-2xl px-4 h-14 mb-4 border border-slate-200">
          ...
          <View className="bg-white flex-row items-center rounded-2xl px-4 h-14 mb-6 border border-slate-200">
