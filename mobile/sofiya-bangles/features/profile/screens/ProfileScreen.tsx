...
export default function ProfileScreen() {
  ...
  return (
    <ScrollView className="flex-1 bg-[#FFF0F3]" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
      {/* Header */}
      <View className="px-6 pb-6 flex-row justify-between items-center" style={{ paddingTop: Math.max(insets.top + 16, 40) }}>
        <Text className="text-2xl font-extrabold text-[#D81B60] font-serif">My Profile</Text>
        <TouchableOpacity className="p-2 bg-white/80 rounded-full shadow-sm border border-rose-100">
          <Ionicons name="settings-outline" size={20} color="#FF1F4B" />
        </TouchableOpacity>
      </View>
      ...
      <View className="bg-white rounded-t-3xl pt-8 px-5 pb-32 shadow-sm border border-slate-100">
        ...
        <View className="bg-amber-50 rounded-3xl p-5 mb-6 border border-amber-100 shadow-sm">
          <View className="flex-row justify-between items-center mb-2">
            <View className="flex-row items-center">
        ...
        <View className="bg-white rounded-3xl border border-slate-100 mb-6 overflow-hidden shadow-sm">
        ...
        <TouchableOpacity 
          ...
          className="bg-rose-50 border border-rose-100 rounded-2xl p-4 flex-row justify-center items-center mb-6 shadow-sm"
        >
