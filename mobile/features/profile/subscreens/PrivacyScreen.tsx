  ...
  return (
    <View className="flex-1 bg-[#FAFAFA]">
      ...
      >
        ...
        <Text className="text-xl font-bold text-text-primary">Privacy Policy</Text>
      </View>
      
      <ScrollView className="flex-1 px-5 pt-6" showsVerticalScrollIndicator={false}>
        <View className="bg-slate-50 p-6 rounded-2xl mb-6">
          <Ionicons name="shield-checkmark" size={32} color="#64748b" className="mb-4" />
          <Text className="text-xl font-bold text-text-primary mb-2">Your Data is Safe</Text>
          <Text className="text-text-secondary leading-5">
            We are committed to protecting your personal information and your right to privacy.
          </Text>
        </View>

        <View className="bg-surface p-6 rounded-2xl border border-divider shadow-sm mb-6">
          <Text className="text-lg font-bold text-text-primary mb-2">1. Information We Collect</Text>
          ...
          <Text className="text-lg font-bold text-text-primary mb-2">2. How We Use Your Data</Text>
          <Text className="text-slate-600 leading-5 mb-4">
          ...
          <Text className="text-lg font-bold text-text-primary mb-2">3. Will Your Information Be Shared?</Text>
          <Text className="text-slate-600 leading-5 mb-4">
          ...
          <Text className="text-lg font-bold text-text-primary mb-2">4. How Long Do We Keep Your Data?</Text>
          <Text className="text-slate-600 leading-5">
            We keep your information for as long as necessary to fulfill the purposes outlined in this privacy notice unless otherwise required by law.
          </Text>
        </View>

        <Text className="text-center text-text-hint text-xs mb-10">Last Updated: June 2026</Text>
        <View className="h-20" />
      </ScrollView>
    </View>
  );
