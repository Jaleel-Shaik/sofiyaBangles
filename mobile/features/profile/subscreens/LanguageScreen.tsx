  ...
  return (
    <View className="flex-1 bg-[#FAFAFA]">
      ...
      <ScrollView className="flex-1 px-5 pt-6" showsVerticalScrollIndicator={false}>
        ...
        <Text className="text-sm font-bold text-text-secondary mb-2 ml-1">APP LANGUAGE</Text>
        <Text className="text-xs text-text-hint mb-6 ml-1 leading-5">
          Select the language you want to use for the app interface and communications.
        </Text>

        <View className="bg-surface rounded-2xl border border-divider mb-10 overflow-hidden shadow-sm">
              ...
              <View className="flex-row items-center">
                ...
                <View>
                  <Text className={`text-base font-bold ${
                    selectedLanguage === lang.code ? 'text-primary' : 'text-text-primary'
                  }`}>
                    {lang.name}
                  </Text>
                  <Text className="text-xs text-text-secondary mt-1">{lang.native}</Text>
                </View>
              </View>
              
              <View className={`w-6 h-6 rounded-full border-2 items-center justify-center ${
                selectedLanguage === lang.code ? 'border-primary' : 'border-slate-300'
              }`}>
