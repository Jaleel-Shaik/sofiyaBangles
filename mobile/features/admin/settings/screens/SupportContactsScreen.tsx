  ...
  return (
    <View className="flex-1 bg-[#FAFAFA]">
      ...
      >
        ...
        <Text className="text-xl font-bold text-text-primary">Support Contacts</Text>
      </View>
      ...
      <ScrollView className="flex-1 px-5 pt-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="mb-5">
          <Text className="text-xs font-bold text-text-secondary uppercase tracking-wider mb-2 ml-1">WhatsApp Number</Text>
          <View className="bg-surface rounded-2xl border border-divider px-4 py-1 flex-row items-center shadow-sm">
          ...
          <Text className="text-[10px] text-text-hint mt-1 ml-2">Include country code (e.g. +91)</Text>
        </View>

        <View className="mb-5">
          <Text className="text-xs font-bold text-text-secondary uppercase tracking-wider mb-2 ml-1">Support Email</Text>
          <View className="bg-surface rounded-2xl border border-divider px-4 py-1 flex-row items-center shadow-sm">
        ...
        <View className="mb-8">
          <Text className="text-xs font-bold text-text-secondary uppercase tracking-wider mb-2 ml-1">Direct Phone Number</Text>
          <View className="bg-surface rounded-2xl border border-divider px-4 py-1 flex-row items-center shadow-sm">
        ...
        >
          {saving ? <ActivityIndicator color="white" /> : <Text className="text-white font-bold text-lg">Update Contacts</Text>}
        </TouchableOpacity>
      </ScrollView>
    </View>
  );
