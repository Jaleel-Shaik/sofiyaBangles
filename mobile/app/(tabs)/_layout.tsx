...
export default function TabLayout() {
  ...
  // Only user role can access user tabs
  if (user?.role === 'admin') return <Redirect href="/(admin)/(tabs)/dashboard" />;
  // super_admin is redirected to login — the LoginScreen shows the restriction modal
  if (user?.role === 'super_admin') return <Redirect href="/login" />;
