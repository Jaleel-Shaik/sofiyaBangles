...
import { AuthRequest, DeviceInformation } from "../types";
...
export const firebaseLoginController = async (req: AuthRequest, res: Response) => {
  try {
    ...
    const { generateTotpSecret, generateQrCodeDataUrl } = require("../utils/totp.utils");
    const { encryptSecret } = require("../utils/crypto.utils");
